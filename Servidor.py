...
def handle_client(client_socket):
    while True:
        ...
        if operation == "send":
            ...
            with open(file_name, 'r') as arquivo_existente, open('C:\\Users\\danie\\OneDrive\\Documentos\\NetBeansProjects\\Cliente\\src\\RecebidoServidor\\' + nome_arquivo, 'w') as file_received:
            ...
            try:
                ...
                with open('C:\\Users\\danie\\OneDrive\\Documentos\\NetBeansProjects\\Cliente\\src\\RecebidoServidor\\' + nome_arquivo, "rb") as f:
                    data = f.read()
